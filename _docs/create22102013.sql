...
-- -----------------------------------------------------
-- Table `tab_status_cupom`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `tab_status_cupom` (
...
CREATE  TABLE IF NOT EXISTS `sis_equipe` (
  ...
  CONSTRAINT `fk_sis_equipe_sis_equipe1`
    ...
    REFERENCES `sis_equipe` (`cod_equipe` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sis_departamento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sis_departamento` ;

CREATE  TABLE IF NOT EXISTS `sis_departamento` (
...
CREATE  TABLE IF NOT EXISTS `sis_usuario` (
  ...
  CONSTRAINT `fk_sis_usuario_sis_perfil1`
    ...
    REFERENCES `sis_perfil` (`cod_perfil` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sis_usuario_sis_departamento1`
    FOREIGN KEY (`cod_sis_departamento` )
    REFERENCES `sis_departamento` (`cod_sis_departamento` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `tab_cupom`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_cupom` ;
...
CREATE  TABLE IF NOT EXISTS `tab_cupom` (
  ...
  CONSTRAINT `fk_status_cupom`
    ...
    REFERENCES `tab_status_cupom` (`cod_status` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_tab_cupom_sis_usuario1`
    ...
    REFERENCES `sis_usuario` (`cod_usuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tab_classif_pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_classif_pessoa` ;

CREATE  TABLE IF NOT EXISTS `tab_classif_pessoa` (
...
CREATE  TABLE IF NOT EXISTS `tab_pessoa` (
  ...
  CONSTRAINT `fk_classif_pessoa_02`
    ...
    REFERENCES `tab_classif_pessoa` (`cod_classif_pessoa` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_tipo_telefone` ;
...
-- -----------------------------------------------------
-- Table `tab_telefone_loja`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_telefone_loja` ;

CREATE  TABLE IF NOT EXISTS `tab_telefone_loja` (
  ...
  CONSTRAINT `fk_tipo_telefone`
    ...
    REFERENCES `tab_tipo_telefone` (`cod_tipo_telefone` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `tab_email_pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_email_pessoa` ;

CREATE  TABLE IF NOT EXISTS `tab_email_pessoa` (
  ...
  CONSTRAINT `fk_pessoa_email`
    ...
    REFERENCES `tab_pessoa` (`cod_pessoa` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `tab_envio_sms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_envio_sms` ;

CREATE  TABLE IF NOT EXISTS `tab_envio_sms` (
  `cod_sms` INT NULL ,
  `cod_pessoa` INT NULL ,
...
-- -----------------------------------------------------
-- Table `tab_envio_email`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_envio_email` ;

CREATE  TABLE IF NOT EXISTS `tab_envio_email` (
  `cod_email` INT NULL ,
  ...
  CONSTRAINT `fk_email_pessoa`
    ...
    REFERENCES `tab_email_pessoa` (`cod_email_pessoa` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_email`
    FOREIGN KEY (`cod_email` )
    REFERENCES `tab_email` (`cod_email` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tab_plano_contas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_plano_contas` ;
...
-- -----------------------------------------------------
-- Table `tab_tipo_servico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_tipo_servico` ;

CREATE  TABLE IF NOT EXISTS `tab_tipo_servico` (
...
-- -----------------------------------------------------
-- Table `tab_plano_propriedades`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_plano_propriedades` ;

CREATE  TABLE IF NOT EXISTS `tab_plano_propriedades` (
  ...
  CONSTRAINT `fk_tipo_svc_propr`
    ...
    REFERENCES `tab_tipo_servico` (`cod_tipo_servico` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_plano_propr`
    FOREIGN KEY (`cod_plano_contas` )
    REFERENCES `tab_plano_contas` (`cod_plano_contas` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `tab_cupom_x_pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_cupom_x_pessoa` ;

CREATE  TABLE IF NOT EXISTS `tab_cupom_x_pessoa` (
  `cod_cupom` INT NULL ,
  `cod_pessoa` INT NULL ,
  ...
  CONSTRAINT `fk_cupom_x_pessoa_01`
    ...
    REFERENCES `tab_cupom` (`cod_cupom` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `tab_cupom_x_tipo_servico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_cupom_x_tipo_servico` ;

CREATE  TABLE IF NOT EXISTS `tab_cupom_x_tipo_servico` (
...
-- Table `tab_transacao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_transacao` ;

CREATE  TABLE IF NOT EXISTS `tab_transacao` (
...
-- -----------------------------------------------------
-- Table `tab_propr_classif_pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_propr_classif_pessoa` ;

CREATE  TABLE IF NOT EXISTS `tab_propr_classif_pessoa` (
...
-- -----------------------------------------------------
-- Table `tab_audit_classificacao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tab_audit_classificacao` ;

CREATE  TABLE IF NOT EXISTS `tab_audit_classificacao` (
...
CREATE  TABLE IF NOT EXISTS `sis_acoes` (
...
-- -----------------------------------------------------
-- Table `sis_equipe_config`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sis_equipe_config` ;

CREATE  TABLE IF NOT EXISTS `sis_equipe_config` (
...
CREATE  TABLE IF NOT EXISTS `sis_menu` (
  ...
  CONSTRAINT `fk_sis_menu_sis_menu1`
    ...
    REFERENCES `sis_menu` (`cod_menu` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sis_menu_sis_permissoes1`
    FOREIGN KEY (`cod_permissao` )
    REFERENCES `sis_permissoes` (`cod_permissao` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sis_perfil_permissoes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sis_perfil_permissoes` ;

CREATE  TABLE IF NOT EXISTS `sis_perfil_permissoes` (
...
-- -----------------------------------------------------
-- Table `sis_permissoes_has_sis_acoes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sis_permissoes_has_sis_acoes` ;

CREATE  TABLE IF NOT EXISTS `sis_permissoes_has_sis_acoes` (
  `cod_permissao` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `sis_usuario_configs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sis_usuario_configs` ;

CREATE  TABLE IF NOT EXISTS `sis_usuario_configs` (
...
INSERT INTO `tab_tipo_servico` (`cod_tipo_servico`, `nom_tipo_servico`, `bol_ativo`) VALUES (NULL, 'SMS', '1');
INSERT INTO `tab_tipo_servico` (`cod_tipo_servico`, `nom_tipo_servico`, `bol_ativo`) VALUES (NULL, 'EMAIL', '1');
INSERT INTO `tab_tipo_servico` (`cod_tipo_servico`, `nom_tipo_servico`, `bol_ativo`) VALUES (NULL, 'VOICE EMAIL', '1');
