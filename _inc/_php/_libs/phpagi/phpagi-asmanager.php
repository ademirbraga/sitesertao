  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['server'])) $this->config['asmanager']['server'] = IP_MANAGER;
      if(!isset($this->config['asmanager']['port'])) $this->config['asmanager']['port'] = PORTA_MANAGER;
