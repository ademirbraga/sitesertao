<?php
	...
	* Arquivo:          ../portalunimed/_inc/_php/_class/Hilum.class.php
	* Tabela:           tab_hilum
	...
	*/
	...
	class TabHilum extends DbUtils{ 
	...
	private $_aplicativo = "appTabHilum.php";
	/**
	 ...
	 */
	private $_nomModulo = txt_TabHilum;
	/**
	...
	*/
	...
	private $_camposLst = array('cod_HILUM' => array('nome'=>'txt_cod_HILUM','tipo'=>'int','sortable'=>'yes', 'tamanho'=> '11'),
		//'cod_usuario' => array('nome'=>'txt_cod_usuario','tipo'=>'int','sortable'=>'yes', 'tamanho'=> '11'),
		'nom_arq_HILUM' => array('nome'=>'txt_nom_arq_HILUM','tipo'=>'varchar','sortable'=>'yes', 'tamanho'=> '225'),
	...
	function getnomModulo(){
		...
		function getCodHilum() { 	return $this->cod_HILUM; }
			function getCodUsuario() { 	return $this->cod_usuario; }
			function getNomArqHilum() { 	return $this->nom_arq_HILUM; }
	...
	// **********************
	    ...
	    function setCodHilum($val) { $this->cod_HILUM =  $val; }
		    function setCodUsuario($val) { $this->cod_usuario =  $val; }
		    function setNomArqHilum($val) { $this->nom_arq_HILUM =  $val; }
	...
	*/
	   ...
	   $caminho = explode("/", trim($data['nom_arq_HILUM']));	   
	    //print_r($caminho);
	    if(empty($caminho[2])){
		$data['nom_arq_HILUM'] = WWW_UPLOAD_TABELA.'_hilum/'.$data['nom_arq_HILUM'];
	    }else
		$data['nom_arq_HILUM'] = $data['nom_arq_HILUM'];
	   ...
	   $cod_HILUM = parent::inserir(NULL, $forceUpdate);
