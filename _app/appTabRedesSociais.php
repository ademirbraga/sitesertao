 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabRedesSociais.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabRedesSociais.php
...
$objPrincipal = new TabRedesSociais();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_redes_sociais = $id");
...
$smarty->assign('modulo', MODULO_TABREDESSOCIAIS);
...
$tplConteudo = $smarty->fetch('tplTabRedesSociais.htm');
?>