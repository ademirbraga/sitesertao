...
* Aplicativo do sistema para trabalhar com a tabela sis_permissoes.
...
* @name _aplicativos/appSisPermissoes.php
...
*/
	...
	$objPrincipal = new SisPermissoes();
	...
	$smarty->assign('modulo', MODULO_SISPERMISSOES);
	...
	$tplConteudo = $smarty->fetch('tplSisPermissoes.htm');
