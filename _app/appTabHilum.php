 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabHilum.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabHilum.php
 * Tabela:           tab_hilum
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabHilum();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_HILUM = $id");
...
$smarty->assign('modulo', MODULO_TABHILUM);
...
$tplConteudo = $smarty->fetch('tplTabHilum.htm');
?>