 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabAgendaCompromisso.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabAgendaCompromisso.php
...
$objPrincipal = new TabAgendaCompromisso();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_agenda_compromisso = $id");
...
$smarty->assign('modulo', MODULO_TABAGENDACOMPROMISSO);
...
$tplConteudo = $smarty->fetch('tplTabAgendaCompromisso.htm');
?>