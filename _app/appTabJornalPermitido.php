 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabJornalPermitido.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabJornalPermitido.php
...
$objPrincipal = new TabJornalPermitido();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_jornal_permitido = $id");
...
$smarty->assign('modulo', MODULO_TABJORNALPERMITIDO);
...
$tplConteudo = $smarty->fetch('tplTabJornalPermitido.htm');
?>