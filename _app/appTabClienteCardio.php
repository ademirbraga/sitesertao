 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabClienteCardio.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabClienteCardio.php
...
$objPrincipal = new TabClienteCardio();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_cliente_cardio = $id");
...
$smarty->assign('modulo', MODULO_TABCLIENTECARDIO);
...
$tplConteudo = $smarty->fetch('tplTabClienteCardio.htm');
?>