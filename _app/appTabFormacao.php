 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabFormacao.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabFormacao.php
 * Tabela:           tab_formacao
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabFormacao();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_formacao = $id");
    $dados = $objPrincipal->getRegistro();

    $smarty->assign('dados', $dados);
}

$smarty->assign('modulo', MODULO_TABFORMACAO);
...
$tplConteudo = $smarty->fetch('tplTabFormacao.htm');
?>