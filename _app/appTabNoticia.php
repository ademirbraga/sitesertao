 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabNoticia.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabNoticia.php
 * Tabela:           tab_noticia
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabNoticia();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $dados = $objPrincipal->listarPorRef(NULL, $where = "A.cod_noticia = $id");
...
$smarty->assign('modulo', MODULO_TABNOTICIA);
...
$tplConteudo = $smarty->fetch('tplTabNoticia.htm');
?>