 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabCertificacaoEspecializacao.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabCertificacaoEspecializacao.php
...
$objPrincipal = new TabCertificacaoEspecializacao();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_certificacao_especializacao = $id");
    $dados = $objPrincipal->getRegistro();

    $smarty->assign('dados', $dados);
}

$smarty->assign('modulo', MODULO_TABCERTIFICACAOESPECIALIZACAO);
...
$tplConteudo = $smarty->fetch('tplTabCertificacaoEspecializacao.htm');
?>