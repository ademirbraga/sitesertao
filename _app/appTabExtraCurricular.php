 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabExtraCurricular.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabExtraCurricular.php
...
$objPrincipal = new TabExtraCurricular();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_extra_curricular = $id");
    $dados = $objPrincipal->getRegistro();

    $smarty->assign('dados', $dados);
}

$smarty->assign('modulo', MODULO_TABEXTRACURRICULAR);
...
$tplConteudo = $smarty->fetch('tplTabExtraCurricular.htm');
?>