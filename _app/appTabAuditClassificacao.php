<?php
	...
	* -------------------------------------------------------
	* Aplicativo:       appTabAuditClassificacao.php
	* Gerada em:        08.10.2013
	* Arquivo:          ../projSertao/_app/appTabAuditClassificacao.php
	...
	*/
	...
	$objPrincipal = new TabAuditClassificacao();
        $NomeModulo = $objPrincipal->getnomModulo();	

	if(!empty($id)){
	
		$objPrincipal->listar(NULL,$where = "cod_audit_classificacao = $id");
		$dados = $objPrincipal->getRegistro();	
		
		$smarty->assign('dados', $dados);
	}	

	$smarty->assign('modulo', MODULO_TABAUDITCLASSIFICACAO);
	...
	$tplConteudo = $smarty->fetch('tplTabAuditClassificacao.htm');
