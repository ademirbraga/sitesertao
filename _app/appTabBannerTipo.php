 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabBannerTipo.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabBannerTipo.php
...
$objPrincipal = new TabBannerTipo();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_banner_tipo = $id");
...
$smarty->assign('modulo', MODULO_TABBANNERTIPO);
...
$tplConteudo = $smarty->fetch('tplTabBannerTipo.htm');
?>