 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabClienteTipo.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabClienteTipo.php
...
$objPrincipal = new TabClienteTipo();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_cliente_tipo = $id");
    $dados = $objPrincipal->getRegistro();

    $smarty->assign('dados', $dados);
}

$smarty->assign('modulo', MODULO_TABCLIENTETIPO);
...
$tplConteudo = $smarty->fetch('tplTabClienteTipo.htm');
?>