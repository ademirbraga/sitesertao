 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabEnqueteAlternativa.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabEnqueteAlternativa.php
...
$objPrincipal = new TabEnqueteAlternativa();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_enquete_alternativa = $id");
...
$smarty->assign('modulo', MODULO_TABENQUETEALTERNATIVA);
...
$tplConteudo = $smarty->fetch('tplTabEnqueteAlternativa.htm');
?>