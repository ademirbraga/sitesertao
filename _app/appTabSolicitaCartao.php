 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabSolicitaCartao.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabSolicitaCartao.php
...
$objPrincipal = new TabSolicitaCartao();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_solicita_cartao = $id");
...
$smarty->assign('modulo', MODULO_TABSOLICITACARTAO);
...
$tplConteudo = $smarty->fetch('tplTabSolicitaCartao.htm');
?>