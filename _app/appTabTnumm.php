 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabTnumm.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabTnumm.php
 * Tabela:           tab_tnumm
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabTnumm();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_TNUMM = $id");
...
$smarty->assign('modulo', MODULO_TABTNUMM);
...
$tplConteudo = $smarty->fetch('tplTabTnumm.htm');
?>