 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabTrabalheConosco.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabTrabalheConosco.php
...
$objPrincipal = new TabTrabalheConosco();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_trabalhe_conosco = $id");
    $dados = $objPrincipal->getRegistro();

    $smarty->assign('dados', $dados);
}

$smarty->assign('modulo', MODULO_TABTRABALHECONOSCO);
...
$tplConteudo = $smarty->fetch('tplTabTrabalheConosco.htm');
?>