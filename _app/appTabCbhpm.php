 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabCbhpm.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabCbhpm.php
 * Tabela:           tab_cbhpm
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabCbhpm();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_CBHPM = $id");
...
$smarty->assign('modulo', MODULO_TABCBHPM);
...
$tplConteudo = $smarty->fetch('tplTabCbhpm.htm');
?>