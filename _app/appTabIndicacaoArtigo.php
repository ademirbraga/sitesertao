 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabIndicacaoArtigo.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabIndicacaoArtigo.php
...
$objPrincipal = new TabIndicacaoArtigo();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_indicacao_artigo = $id");
...
$smarty->assign('modulo', MODULO_TABINDICACAOARTIGO);
...
$tplConteudo = $smarty->fetch('tplTabIndicacaoArtigo.htm');
?>