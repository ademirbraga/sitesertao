<?php
	...
	* -------------------------------------------------------
	* Aplicativo:       appTabSms.php
	* Gerada em:        08.10.2013
	* Arquivo:          ../projSertao/_app/appTabSms.php
	* Tabela:           tab_sms
	...
	*/
	...
	$smarty->assign('modulo', MODULO_TABSMS);
	...
	$tplConteudo = $smarty->fetch('tplTabSms.htm');
