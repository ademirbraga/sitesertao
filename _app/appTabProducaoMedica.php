 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabProducaoMedica.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabProducaoMedica.php
...
$objPrincipal = new TabProducaoMedica();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_producao_medica = $id");
...
$smarty->assign('modulo', MODULO_TABPRODUCAOMEDICA);
...
$tplConteudo = $smarty->fetch('tplTabProducaoMedica.htm');
?>