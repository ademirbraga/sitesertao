 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabManualCooperado.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabManualCooperado.php
...
$objPrincipal = new TabManualCooperado();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_manual_cooperado = $id");
...
$smarty->assign('modulo', MODULO_TABMANUALCOOPERADO);
...
$tplConteudo = $smarty->fetch('tplTabManualCooperado.htm');
?>