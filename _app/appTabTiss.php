 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabTiss.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabTiss.php
 * Tabela:           tab_tiss
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabTiss();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_TISS = $id");
...
$smarty->assign('modulo', MODULO_TABTISS);
...
$tplConteudo = $smarty->fetch('tplTabTiss.htm');
?>