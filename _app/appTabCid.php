 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabCid.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabCid.php
 * Tabela:           tab_cid
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabCid();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_CID = $id");
...
$smarty->assign('modulo', MODULO_TABCID);
...
$tplConteudo = $smarty->fetch('tplTabCid.htm');
?>