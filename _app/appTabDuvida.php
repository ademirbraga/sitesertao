 ...
 * -------------------------------------------------------
 * Aplicativo:       appTabDuvida.php
 * Gerada em:        08.08.2013
 * Arquivo:          ../sertao/_app/appTabDuvida.php
 * Tabela:           tab_duvida
 ** Banco:	    bdsertao
 * -------------------------------------------------------	
 *
...
$objPrincipal = new TabDuvida();
$NomeModulo = $objPrincipal->getnomModulo();

if (!empty($id)) {

    $objPrincipal->listar(NULL, $where = "cod_duvida = $id");
...
$smarty->assign('modulo', MODULO_TABDUVIDA);
...
$tplConteudo = $smarty->fetch('tplTabDuvida.htm');
?>